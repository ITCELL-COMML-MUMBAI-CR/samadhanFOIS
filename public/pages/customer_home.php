                        ...
                        <div class="news-card" data-aos="slide-right" data-aos-delay="<?php echo $index * 150; ?>">
                            ...
                            <?php if (!empty($news['link_url'])): ?>
                                <div class="news-card-footer">
                                    <a href="<?php echo htmlspecialchars($news['link_url']); ?>" class="btn btn-link btn-sm" target="_blank">
                            ...
                            <div class="announcement-content">
                                ...
                                <div class="announcement-meta">
                                    ...
                                    <small class="text-muted ms-2">
                                        <i class="fas fa-clock"></i> <?php echo date('M d', strtotime($announcement['created_at'])); ?>
                                    </small>
                                </div>
                            </div>
                            <?php if (!empty($announcement['link_url'])): ?>
                                <div class="announcement-action">
                                    <a href="<?php echo htmlspecialchars($announcement['link_url']); ?>" class="btn btn-warning btn-sm" target="_blank">
                            ...
                            <div class="advertisement-card">
                                ...
                                <div class="advertisement-content">
                                    ...
                                    <?php if (!empty($ad['link_url'])): ?>
                                        <a href="<?php echo htmlspecialchars($ad['link_url']); ?>" class="btn btn-success btn-sm" target="_blank">
            ...
            <div class="quick-actions-section">
                ...
                <div class="quick-actions-grid">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo BASE_URL; ?>grievances/new" class="quick-action-card grievance-action" data-aos="flip-left" data-aos-delay="100">
                            <div class="quick-action-icon">
                                <i class="fas fa-plus-circle"></i>
                            </div>
                            <div class="quick-action-content">
                                <h5>File New Grievance</h5>
                                <p>Submit a new complaint</p>
                            </div>
                        </a>
                        
                        <a href="<?php echo BASE_URL; ?>grievances/my" class="quick-action-card grievance-action" data-aos="flip-left" data-aos-delay="200">
                            <div class="quick-action-icon">
        ...
        <div class="col-12">
            <div class="help-section" data-aos="fade-up">
                <div class="help-content">
                    <h4><i class="fas fa-question-circle text-info"></i> Need Help?</h4>
                    <p>If you have any questions or need assistance, our support team is here to help you.</p>
                    <div class="help-actions">
                        <a href="<?php echo BASE_URL; ?>faq" class="btn btn-outline-info">
                            <i class="fas fa-question"></i> FAQ
                        </a>
                        <a href="<?php echo BASE_URL; ?>contact" class="btn btn-outline-info ms-2">
                            <i class="fas fa-envelope"></i> Contact Support
                        </a>
                        <a href="<?php echo BASE_URL; ?>guidelines" class="btn btn-outline-info ms-2">
